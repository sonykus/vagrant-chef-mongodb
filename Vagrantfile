...
# ChefDK box: 
  ...
  config.vm.define "chefdev" do |chefdev|
    ...
    chefdev.vm.provision :shell, path: "bootstrap_chefdev.sh"
    ...
    chefdev.vm.box = "chef/centos-6.5"
...
# MongoDB boxes:
  ...
  (1..3).each do |i|
    ...
    config.vm.define "mongodb#{i}" do |mongodb|
      ...
      mongodb.vm.provision :shell, path: "bootstrap_mongodb.sh"
      ...
      mongodb.vm.box = "chef/centos-6.5"
